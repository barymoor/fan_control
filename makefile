...
MY_CFLAGS = -Wall -pthread -I $(XILINX_INC) -L$(XILINX_LIBDIR) -I$(XILINX_OTHER_LIB_BASE_PATH)/include
...
MY_LIBS   = -lm -ldl -lrt -lpthread -ljansson -L$(XILINX_OTHER_LIB_BASE_PATH)/lib
